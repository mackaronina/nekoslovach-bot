...
from app.utils.ai_generate import generate_new_from_title, generate_poll, generate_new_from_img_and_title, \
...
async def msg_photo_and_caption(message: Message, ai_client: AsyncOpenAI) -> None:
    new_text = await generate_new_from_img_and_title(ai_client, message)
...
async def msg_text(message: Message, ai_client: AsyncOpenAI) -> None:
    new_text = await generate_new_from_title(ai_client, message)
